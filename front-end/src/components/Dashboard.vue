...
import type { Product, Colors } from '../lib/types'
  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-6">
          <div>
            ...
            <p class="text-gray-600">Manage your furniture inventory</p>
          </div>
          <button
            @click="openAddModal"
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">{{ dashboardStats.totalProducts }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">{{ dashboardStats.totalStock }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">{{ dashboardStats.lowStock }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">{{ formatCurrency(dashboardStats.totalValue) }}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="flex gap-2">
              ...
              <button
                ...
                class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
              ...
              <tr v-for="product in paginatedProducts" :key="product.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span :class="`px-2 py-1 text-xs font-medium rounded-full ${getStockStatus(product.amount).class}`">
                    {{ getStockStatus(product.amount).status }}
                  </span>
                </td>
    ...
    <div v-if="isAddModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="addProduct" class="p-6 space-y-6">
